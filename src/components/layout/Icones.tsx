//Ícones inline em vez dos SVGs de /public/icons: como usam `currentColor`, herdam a
//cor do estado (ativo, hover, desabilitado) sem precisar de um arquivo por variação.

interface IconeProps {
    size?: number;
}

export function IconePainel({ size = 19 }: IconeProps) {
    return (
...
export function IconeDespesas({ size = 19 }: IconeProps) {
    return (
...
export function IconeRelatorios({ size = 19 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true">
...
export function IconeMembros({ size = 19 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
            <circle cx="9" cy="8" r="3.5" />
            <path d="M2 20a7 7 0 0 1 14 0M17 14a5 5 0 0 1 5 5" />
        </svg>
    );
}
...
export function IconeConfiguracoes({ size = 19 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconeSino({ size = 18 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconeConta({ size = 19 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
...
export function IconeMais({ size = 22 }: IconeProps) {
    return (
...
export function IconeVoltar({ size = 18 }: IconeProps) {
    return (
...
export function IconeLua({ size = 18 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconeSair({ size = 18 }: IconeProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
